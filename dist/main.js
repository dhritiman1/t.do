  ...
  const save = (type) => {
    ...
    saveBtn.addEventListener("click", () => {
      if ((0,_func_errorCheck__WEBPACK_IMPORTED_MODULE_3__["default"])(title.value, priority.value, `${type}`)) {
        if (type === "todo") {
          todos.addTodo((0,_todo__WEBPACK_IMPORTED_MODULE_0__["default"])(title.value, priority.value, false));

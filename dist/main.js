...
const DOMFunctions = () => {
  ...
  const dispDate = (() => {
    ...
    date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(), "dd.MM.yyyy");
  })();

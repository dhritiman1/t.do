...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (errorCheck);
...
/* harmony import */ var _func_toggle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../func/toggle */ "./src/func/toggle.js");
/* harmony import */ var _func_form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../func/form */ "./src/func/form.js");
/* harmony import */ var _func_errorCheck__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../func/errorCheck */ "./src/func/errorCheck.js");
...
/* harmony import */ var _projectlist__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./projectlist */ "./src/modules/projectlist.js");
/* harmony import */ var _project__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./project */ "./src/modules/project.js");
/* harmony import */ var _func_sort__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../func/sort */ "./src/func/sort.js");
...
const DOMFunctions = () => {
  const toggleFunc = (0,_func_toggle__WEBPACK_IMPORTED_MODULE_1__["default"])();
  const formFunc = (0,_func_form__WEBPACK_IMPORTED_MODULE_2__["default"])();
  const todos = (0,_todolist__WEBPACK_IMPORTED_MODULE_4__["default"])();
  const projects = (0,_projectlist__WEBPACK_IMPORTED_MODULE_6__["default"])();
  const storageFunc = (0,_storage__WEBPACK_IMPORTED_MODULE_5__["default"])();
  ...
  const save = (type) => {
    ...
    saveBtn.addEventListener("click", () => {
      if ((0,_func_errorCheck__WEBPACK_IMPORTED_MODULE_3__["default"])(title.value, priority.value, `${type}`)) {
        if (type === "todo") {
          todos.addTodo((0,_todo__WEBPACK_IMPORTED_MODULE_0__["default"])(title.value, priority.value));
          storageFunc.storeTodos(todos.getTodos());
          fillList(storageFunc.getTodos(), "todo");
          updateCount(storageFunc.getTodos(), "todo");
        } else {
          projects.addProject(
            (0,_project__WEBPACK_IMPORTED_MODULE_7__["default"])(title.value, priority.value, description.value)
          );
  ...
  const makeTodo = (title, priority, checked, id) => {
    ...
    (0,_func_sort__WEBPACK_IMPORTED_MODULE_8__["default"])("todo", todo, priority);
  ...
  const makeProject = (title, desc, priority, id) => {
    ...
    (0,_func_sort__WEBPACK_IMPORTED_MODULE_8__["default"])("project", project, priority);
  ...
  const dispDate = (() => {
    ...
    date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(new Date(), "dd.MM.yyyy");
  })();
...
const projectList = () => {
  let storage = (0,_storage__WEBPACK_IMPORTED_MODULE_0__["default"])();

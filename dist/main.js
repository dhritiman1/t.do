...
const DOMFunctions = () => {
  const todoFunc = (0,_todo__WEBPACK_IMPORTED_MODULE_0__["default"])();
  ...
  const dispDate = (() => {
    ...
    date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), "dd.MM.yyyy");
  })();
  ...
  const todoForm = (() => {
    ...
    const btnBox = document.querySelector(".add");
  ...
  const saveTodo = (() => {
    ...
    const todoPrior = document.querySelector("#todo-priority");

    saveBtn.addEventListener("click", () => {
      console.log(errorCheck(todoTitle.value, todoPrior.value));
      if (errorCheck(todoTitle.value, todoPrior.value)) {
        todoFunc.createTodo(todoTitle.value, todoPrior.value);
  ...
  const errorCheck = (title, priority) => {
    const error = document.querySelector(".t-error-msg");
